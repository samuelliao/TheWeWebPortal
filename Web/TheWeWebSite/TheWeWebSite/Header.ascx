    ...
    <nav id="nav">
        <ul>
            ...
            <li runat="server" id="li1">
                <asp:LinkButton runat="server" Text="<%$ Resources:Resource,SettingString%>" ID="btnSetting" PostBackUrl="~/Setting/AccInfoSetting.aspx" />
                <ul>
                    <li>
                        <asp:LinkButton runat="server" Text="<%$ Resources:Resource,AccountSettingString%>" ID="btnAccSetting"  PostBackUrl="~/Setting/AccInfoSetting.aspx" />
                    </li>
                    <li>
