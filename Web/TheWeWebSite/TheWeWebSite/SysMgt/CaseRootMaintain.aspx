    ...
    <form runat="server">
        <div id="page-wrapper">
            ...
            <section id="banner">
                ...
                <p>
                    <asp:Label runat="server" Text="<%$ Resources:Resource,SysMgtString%>"></asp:Label>
                </p>
            ...
            <section id="main" class="container">
                ...
                <section class="box special">
                    <header class="major">
                        <h3>
                            <asp:Label runat="server" Text="案件權限"></asp:Label></h3>
                        <hr />
                    </header>
                    <!-- Input -->
                    ...
                    <div class="row">
                        <div class="12u">
                            <h4><asp:Label runat="server" Text="<%$ Resources:Resource,SearchResultString%>" /></h4>
                            <hr />
