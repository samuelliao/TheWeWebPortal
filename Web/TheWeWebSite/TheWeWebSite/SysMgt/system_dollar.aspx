...
<div  style="padding-top:10px;" >
                ...
                <asp:Button ID="Button2" runat="server" Text="幣別" class="btn_6" />

  </div>
     
<div style="padding-top:20px;" 　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　>
    <asp:Label ID="labeldollar" runat="server" Text="幣別:"></asp:Label>
    <input type="text" placeholder="請輸入幣別..."/>
  ...
  <table class="tablestyle"> 
    ...
    <tr>
      ...
      <td class="text-left">35.123</td>
      <td class="text-left">2016/07/05</td>
      <td class="text-left">Joye</td>

    </tr>
    <tr>
       <td class="text-left">¥</td>
      <td class="text-left">0.35123</td>
      <td class="text-left">2016/07/05</td>
      <td class="text-left">Joye</td>
