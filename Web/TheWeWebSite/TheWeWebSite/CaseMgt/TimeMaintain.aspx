        ...
        <div id="page-wrapper">
            ...
            <section id="main" class="container">
                ...
                <section class="box special">
                    <header class="major">
                        <h3>
                            <asp:Label runat="server" Text="時程維護"></asp:Label></h3>
                        <hr />
                    </header>
                    <!-- Input -->
                    ...
                    <div class="row">
                        <div class="12u">
                            ...
                            <div class="row uniform 50%">
                                <div class="6u 12u(mobilep)">
                                    <input placeholder="請輸入會議日期..." type="text" onfocus="(this.type='date')" id="date" />
                                </div>
                            </div>
                            ...
                            <div class="row uniform">
                                <div class="12u">
                                    <ul class="actions">
                                        <li>
                                            <asp:Button runat="server" CssClass="button alt" Text="預約" />
                                        </li>
                                        <li>
